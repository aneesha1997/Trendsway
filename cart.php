...
echo $user['name']; ?> Shopping Cart</h1> 
    ...
    <nav> 
        <ul> 
            ...
            <li> 
                <a href= 
"mailto:aneeshaks655@gmail.com">Contact Us</a> 
            </li> 
            <li> 
    ...
    <main> 
        <section> 
            <table> 
                ...
                // Handle the case where $_SESSION['cart'] is not set or is not an array
    ...
    <footer> 
        <p>&COPY;2024 TrendSway Shopping Web Application</p> 
    </footer> 
</body> 
